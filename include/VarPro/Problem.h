...
namespace VarPro
{
  ...
  struct Manifolds
  {
    ...
    ScaledStiefelProduct scaled_stiefel_prod_manifold_;
    bool use_scaled_stiefel_{false};
    ...
    {
      use_scaled_stiefel_ = true;
      // fill out scaled Stiefel manifold with same parameters as Stiefel
      // manifold
      scaled_stiefel_prod_manifold_ =
          ScaledStiefelProduct(stiefel_prod_manifold_.get_k(),
                               stiefel_prod_manifold_.get_p(),
                               stiefel_prod_manifold_.get_n());

      //  empty the Stiefel manifold
      stiefel_prod_manifold_ = StiefelProduct();
    }
  };
